...
function M.Provider:add_push_image(image, opts) end
...
---@param opts? FalculaServiceServiceOpts Options for the service.
function M.Provider:add_push_images(images, opts) end

---@class (exact) FalculaComposeProvider.BuildInfo Information to build a service.
...
---@class (exact) FalculaComposeProvider.BuildServiceOpts: FalculaServiceServiceOpts Options for the 'Build' service.
...
---@class (exact) FalculaComposeProvider.PushServiceOpts: FalculaServiceServiceOpts Options for the 'Push' service.
